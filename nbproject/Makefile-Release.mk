...
${OBJECTDIR}/src/sds.o: src/sds.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/sds.o src/sds.c

${OBJECTDIR}/src/net.o: src/net.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/net.o src/net.c
...
${OBJECTDIR}/src/hiredis.o: src/hiredis.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/hiredis.o src/hiredis.c
